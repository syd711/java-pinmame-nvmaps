...
public class SparseMemory {
  ...
  private NVRamMap mapJson;

  public SparseMemory(NVRamMap mapJson) {
  ...
  public Nibble getRegionNibble(int address) {
  ...
  public List<Object> getSharedValue(String values) {
