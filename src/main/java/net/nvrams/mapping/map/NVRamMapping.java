...
public class NVRamMapping extends NVRamObject {
  ...
  public byte[] getBytes(SparseMemory memory) {
  ...
  public Nibble nibble(SparseMemory mapJson) {
    ...
    Nibble n = mapJson.getRegionNibble(address);
    return n != null ? n : Nibble.BOTH;
  }
  ...
  public List<Object> entryValues(SparseMemory memory) {
    ...
    if (values instanceof String) {
      return memory.getSharedValue((String) values);
    }
  ...
  public String formatEntry(SparseMemory memory, Locale locale) {
    ...
    if ("bcd".equals(encoding) || "int".equals(encoding)) {
      ...
      List<Object> values = entryValues(memory);
