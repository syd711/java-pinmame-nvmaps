...
public abstract class SimpleLogger extends LegacyAbstractLogger {
    ...
    public abstract void log(LEVEL level, String msg, Object[] args, Throwable t);

    // --- SLF4J 2.0+ Required Implementations ---
    ...
    protected void handleNormalizedLoggingCall(org.slf4j.event.Level level, Marker marker, String msg, Object[] arguments, Throwable throwable) {
        // Maps SLF4J 2.0 Fluent API calls back to your custom legacy log() method
        LEVEL mappedLevel = LEVEL.valueOf(level.name());
        log(mappedLevel, msg, arguments, throwable);
    }
